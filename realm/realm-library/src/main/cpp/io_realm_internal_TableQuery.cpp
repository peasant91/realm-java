...
static TableRef getTableForLinkQuery(jlong nativeQueryPtr, JLongArrayAccessor& tablesArray,
                                     JLongArrayAccessor& indicesArray)
{
...
static TableRef getTableByArray(jlong nativeQueryPtr, JLongArrayAccessor& tablesArray,
                                JLongArrayAccessor& indicesArray)
{
    auto table_ref = reinterpret_cast<Query *>(nativeQueryPtr)->get_table();
    jsize link_element_count = indicesArray.size() - 1;
